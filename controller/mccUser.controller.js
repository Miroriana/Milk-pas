...
const addMccUser = async (req, res, next) => {
  ...
  const removeMccUser = async (req, res, next) => {
    ...
    const updateMccUser = async(req,res,next) =>{
        ...
        try {
            var updatedMccUser = await MccUserModel.findByIdAndUpdate({_id:req.query.id}, req.body);
    ...
    module.exports = { addMccUser, removeMccUser,findMccUserById,listOfMccUser,updateMccUser};
